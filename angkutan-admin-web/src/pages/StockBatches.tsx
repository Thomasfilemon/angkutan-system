  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mb-4 p-2 bg-yellow-50 border border-yellow-200 rounded">
        ...
        <p>
          First Batch Quantity Type:{" "}
          {batches[0] ? typeof batches[0].quantity : "N/A"}
        </p>
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600">
              {stockItem.item_name} - Current Stock: {stockItem.current_stock}{" "}
              {stockItem.unit}
            </p>
          </div>
              ...
              {batches.length === 0 ? (
                ...
                batches.map((batch) => {
                  ...
                  const usagePercentage =
                    originalQty > 0 ? (usedQty / originalQty) * 100 : 0;
                  ...
                  return (
                    <tr key={batch.id} className="hover:bg-gray-50">
                      ...
                      <td className="py-2 px-4 border-b">
                        Rp{" "}
                        {(currentQty * batch.unit_price).toLocaleString(
                          "id-ID"
                        )}
                      </td>
                      <td className="py-2 px-4 border-b">
                      ...
                      <td className="py-2 px-4 border-b text-right">
                        {batch.last_edited_by && (
                          <div className="text-xs text-gray-600">
                            Diubah oleh {batch.last_edited_by} •{" "}
                            {new Date(
                              batch.last_edited_at || ""
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-sm text-blue-700">
              Batches are sorted by purchase date (oldest first). When stock is
              deducted, the system automatically uses the oldest batches first
            ...
            <div className="text-sm text-green-700 space-y-1">
              ...
              <p>
                ...
                <span className="font-semibold">
                  {batches.filter((b) => toNumber(b.quantity) > 0).length}
                </span>
              </p>
              <p>
                Total Value:{" "}
                <span className="font-semibold">
                  ...
                  {batches
                    .reduce(
                      (sum, batch) =>
                        sum + toNumber(batch.quantity) * batch.unit_price,
                      0
                    )
                    .toLocaleString("id-ID")}
                </span>
